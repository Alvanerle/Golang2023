...
import (
	...
	"Printers.imangalizhumash.net/internal/jsonlog"
	"Printers.imangalizhumash.net/internal/mailer"
	"context"
	"database/sql"
	"flag"
	_ "github.com/lib/pq"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn",
		"postgres://imangali:pa55word@db/golang-project?sslmode=disable",
		"PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "d7bf3e78ebc1ff", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "1753a50ed1e754", "SMTP password")
